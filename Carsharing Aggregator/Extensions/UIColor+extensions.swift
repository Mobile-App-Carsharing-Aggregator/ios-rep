...
//
//  Created by Дарья Шишмакова on 12.12.2023.
//
...
struct CarsharingColors {
    ...
    let black = #colorLiteral(red: 0.1098039216, green: 0.1098039216, blue: 0.1176470588, alpha: 1)
    let greyDark = #colorLiteral(red: 0.4039215686, green: 0.4039215686, blue: 0.4039215686, alpha: 1)
    let greyMedium = #colorLiteral(red: 0.6823529412, green: 0.6823529412, blue: 0.6980392157, alpha: 1)
